...
public class HashSetEjemplos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Elementos en el Set dnis: " + dnis.size());
		System.out.println("Elementos en el Set nombres: " + nombres.size());
		...
		System.out.println("Elementos en el Set dnis: " + dnis.size());
		System.out.println("Elementos en el Set nombres: " + nombres.size());//Comparar el tamaño luego de remover
	}
}